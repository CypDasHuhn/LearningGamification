...
type AsyncParameters<FS extends Callback[], P = Parameters<FS[0]>[0]> = FS extends [
  infer H,
  ...infer Rest,
]
...
export function asyncPipe<A, B>(ab: (a: A) => MaybePromise<B>): (a: A) => Promise<B>;
 ...
 */
export function asyncPipe<FS extends any[]>(...fns: AsyncParameters<FS>): AsyncPipeReturnType<FS>;
